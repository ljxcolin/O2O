...
import stu.ljx.o2o.util.wechat.WechatUtil;

/**
 * 获取关注公众号之后的微信用户信息的接口，如果在微信浏览器里访问
 * https://open.weixin.qq.com/connect/oauth2/authorize?
 * appid=xxx&redirect_uri=http://ljxcolin.xyz/o2o/wechat/login&
...
public class WechatLoginController {
	 ...
	 public String doGet(HttpServletRequest request, HttpServletResponse response) {
		 log.debug("wechat login getting...");
		 ...
		 if (code != null) {
			 try {
				 ...
				 log.error("getUserAccessToken or getUserInfo or findByOpenId error: {}", e.toString());
				 e.printStackTrace();
			 }
		 }
