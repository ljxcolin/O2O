...
public class JedisKit {
    ...
    public class Keys {
        ...
        /**
         * 更改key
         * @param String oldKey 旧的key
         * @param String newKey 新的key
         * @return 状态码
         * */
         ...
         * @param String key
         * @param SortingParams params定义排序类型或limit的起止位置.
    ...
    public class Hash {
        ...
        public boolean hexists(String key, String fieid) {
            //ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
            boolean status = sjedis.hexists(key, fieid);
            sjedis.close();
            return status;
        }
        ...
        public String hget(String key, String fieid) {
            //ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
            String value = sjedis.hget(key, fieid);
            sjedis.close();
            return value;
        }
        ...
        public byte[] hget(byte[] key, byte[] fieid) {
            //ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
            byte[] value = sjedis.hget(key, fieid);
            sjedis.close();
            return value;
        }
        ...
        public Map<String, String> hgetAll(String key) {
            //ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
            Map<String, String> hashMap = sjedis.hgetAll(key);
            sjedis.close();
            return hashMap;
        }
        ...
        public List<String> hvals(String key) {
            //ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
            List<String> valueList = sjedis.hvals(key);
            sjedis.close();
            return valueList;
        }
        ...
        public Long hincrby(String key, String fieid, Long value) {
            Jedis jedis = getJedis();
            Long newVaule = jedis.hincrBy(key, fieid, value);
            jedis.close();
            return newVaule;
        }
        ...
        public Set<String> hkeys(String key) {
            //ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
            Set<String> fieldSet = sjedis.hkeys(key);
            sjedis.close();
            return fieldSet;
        }
        ...
        public List<String> hmget(String key, String... fieids) {
            //ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
            List<String> valueList = sjedis.hmget(key, fieids);
            sjedis.close();
            return valueList;
        }
        ...
        public List<byte[]> hmget(byte[] key, byte[]... fieids) {
            //ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
            List<byte[]> valueList = sjedis.hmget(key, fieids);
            sjedis.close();
            return valueList;
        }
    ...
    public class Sets {
        ...
        public boolean sismember(String key, String member) {
            //ShardedJedis sjedis = getShardedJedis();
            Jedis sjedis = getJedis();
            boolean status = sjedis.sismember(key, member);
            sjedis.close();
            return status;
        }
